...
## Trend narrative
- Estimated tokens moved down by 161,182 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,808,628 est tokens) · gpt-5.4 (1,750,150 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,211,473 est tokens) · trading-commander (486,976 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,654,902 est tokens) · cron (1,714,827 est tokens) · system/other (0 est tokens)
