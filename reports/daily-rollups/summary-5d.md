...
## Trend narrative
- Estimated tokens moved up by 297,293 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,471,162 est tokens) · gpt-5-mini (1,250,865 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,366,838 est tokens) · builder (337,038 est tokens) · trading-commander (220,765 est tokens)
- Top attribution buckets: interactive (1,991,055 est tokens) · cron (1,100,008 est tokens) · system/other (0 est tokens)
