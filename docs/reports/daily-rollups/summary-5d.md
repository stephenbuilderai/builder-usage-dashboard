...
## Trend narrative
- Estimated tokens moved down by 42,301 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,398,425 est tokens) · gpt-5-mini (1,186,602 est tokens) · gpt-5.2 (363,823 est tokens)
- Top agents: main (2,457,239 est tokens) · builder (337,038 est tokens) · trading-commander (325,189 est tokens)
- Top attribution buckets: interactive (1,887,391 est tokens) · cron (1,398,497 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +23.6% token shift vs previous day
