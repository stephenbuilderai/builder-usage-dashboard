...
## Trend narrative
- Estimated tokens moved down by 187,970 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,873,628 est tokens) · gpt-5.4 (1,720,939 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,211,617 est tokens) · trading-commander (460,044 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,637,724 est tokens) · cron (1,705,217 est tokens) · system/other (0 est tokens)
