...
## Trend narrative
- Estimated tokens moved down by 267,097 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,945,555 est tokens) · gpt-5.4 (1,752,266 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,169,512 est tokens) · builder (449,384 est tokens) · trading-commander (423,022 est tokens)
- Top attribution buckets: interactive (2,594,392 est tokens) · cron (1,669,422 est tokens) · system/other (0 est tokens)
