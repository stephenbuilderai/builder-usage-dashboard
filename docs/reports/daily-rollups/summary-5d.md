...
## Trend narrative
- Estimated tokens moved down by 142,087 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,619,915 est tokens) · gpt-5.4 (1,449,361 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,604,533 est tokens) · trading-commander (346,534 est tokens) · builder (337,038 est tokens)
- Top attribution buckets: interactive (2,220,757 est tokens) · cron (1,233,770 est tokens) · system/other (0 est tokens)
