...
## Trend narrative
- Estimated tokens moved up by 297,538 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,490,985 est tokens) · gpt-5-mini (1,231,287 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,367,083 est tokens) · builder (337,038 est tokens) · trading-commander (220,765 est tokens)
- Top attribution buckets: interactive (1,991,379 est tokens) · cron (1,099,929 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-13: +20.9% token shift vs previous day
