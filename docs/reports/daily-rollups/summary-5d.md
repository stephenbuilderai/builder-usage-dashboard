...
## Trend narrative
- Estimated tokens moved down by 236,325 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,873,630 est tokens) · gpt-5.4 (1,673,027 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,207,678 est tokens) · builder (449,384 est tokens) · trading-commander (415,628 est tokens)
- Top attribution buckets: interactive (2,607,642 est tokens) · cron (1,686,944 est tokens) · system/other (0 est tokens)
