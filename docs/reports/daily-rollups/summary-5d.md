...
## Trend narrative
- Estimated tokens moved down by 13,895 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,391,920 est tokens) · gpt-5-mini (1,152,361 est tokens) · gpt-5.2 (400,732 est tokens)
- Top agents: main (2,506,271 est tokens) · builder (337,038 est tokens) · trading-commander (304,563 est tokens)
- Top attribution buckets: interactive (1,909,863 est tokens) · cron (1,404,431 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +26.6% token shift vs previous day
