...
## Trend narrative
- Estimated tokens moved down by 5,266 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,270,262 est tokens) · gpt-5-mini (1,149,206 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,146,055 est tokens) · builder (337,038 est tokens) · trading-commander (138,989 est tokens)
- Top attribution buckets: interactive (1,781,776 est tokens) · cron (1,006,728 est tokens) · system/other (0 est tokens)
