...
## Trend narrative
- Estimated tokens moved down by 200,177 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,633,375 est tokens) · gpt-5.4 (1,394,026 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,546,443 est tokens) · trading-commander (346,534 est tokens) · builder (337,038 est tokens)
- Top attribution buckets: interactive (2,163,652 est tokens) · cron (1,232,785 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -16.5% token shift vs previous day
