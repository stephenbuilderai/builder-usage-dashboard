...
## Trend narrative
- Estimated tokens moved down by 1,987 across the available window.
...
- Top agents: main (3,314,669 est tokens) · trading-commander (535,277 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,617,233 est tokens) · cron (1,903,993 est tokens) · system/other (0 est tokens)
