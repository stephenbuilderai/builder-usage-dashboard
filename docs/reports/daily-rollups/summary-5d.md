...
## Trend narrative
- Estimated tokens moved down by 186,115 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,874,592 est tokens) · gpt-5.4 (1,721,833 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,212,578 est tokens) · trading-commander (460,938 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,637,724 est tokens) · cron (1,707,072 est tokens) · system/other (0 est tokens)
