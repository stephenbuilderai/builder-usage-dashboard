...
## Trend narrative
- Estimated tokens moved down by 222,819 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,873,624 est tokens) · gpt-5.4 (1,686,511 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,201,299 est tokens) · builder (449,384 est tokens) · trading-commander (435,513 est tokens)
- Top attribution buckets: interactive (2,621,941 est tokens) · cron (1,686,151 est tokens) · system/other (0 est tokens)
