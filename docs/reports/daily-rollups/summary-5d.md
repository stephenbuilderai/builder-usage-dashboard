...
## Trend narrative
- Estimated tokens moved down by 178,959 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,873,624 est tokens) · gpt-5.4 (1,729,969 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,211,598 est tokens) · trading-commander (469,074 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,639,687 est tokens) · cron (1,712,265 est tokens) · system/other (0 est tokens)
