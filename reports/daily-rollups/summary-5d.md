...
## Trend narrative
- Estimated tokens moved up by 2,286 across the available window.
...
- Top agents: main (2,493,441 est tokens) · builder (337,038 est tokens) · trading-commander (333,574 est tokens)
- Top attribution buckets: interactive (1,953,787 est tokens) · cron (1,376,688 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +28.4% token shift vs previous day
