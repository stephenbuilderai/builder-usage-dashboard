...
## Trend narrative
- Estimated tokens moved down by 3,157 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,981,595 est tokens) · gpt-5.4 (1,902,876 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,358,705 est tokens) · builder (449,384 est tokens) · trading-commander (346,534 est tokens)
- Top attribution buckets: interactive (2,843,070 est tokens) · cron (1,533,449 est tokens) · system/other (0 est tokens)
