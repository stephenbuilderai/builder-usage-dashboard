...
## Trend narrative
- Estimated tokens moved up by 108,200 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,452,314 est tokens) · gpt-5-mini (1,080,620 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,398,510 est tokens) · builder (337,038 est tokens) · growth-researcher (35,034 est tokens)
- Top attribution buckets: interactive (1,875,112 est tokens) · cron (1,026,858 est tokens) · system/other (0 est tokens)
