...
## Trend narrative
- Estimated tokens moved down by 198,953 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,634,933 est tokens) · gpt-5.4 (1,393,692 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,547,667 est tokens) · trading-commander (346,534 est tokens) · builder (337,038 est tokens)
- Top attribution buckets: interactive (2,163,858 est tokens) · cron (1,233,803 est tokens) · system/other (0 est tokens)
