...
## Trend narrative
- Estimated tokens moved down by 195,338 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,634,124 est tokens) · gpt-5.4 (1,398,116 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,551,282 est tokens) · trading-commander (346,534 est tokens) · builder (337,038 est tokens)
- Top attribution buckets: interactive (2,168,069 est tokens) · cron (1,233,207 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -16.1% token shift vs previous day
