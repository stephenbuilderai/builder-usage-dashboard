...
## Trend narrative
- Estimated tokens moved up by 198,620 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,452,689 est tokens) · gpt-5-mini (1,170,665 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,488,930 est tokens) · builder (337,038 est tokens) · growth-researcher (35,034 est tokens)
- Top attribution buckets: interactive (1,876,281 est tokens) · cron (1,116,109 est tokens) · system/other (0 est tokens)
