...
## Trend narrative
- Estimated tokens moved down by 266,749 across the available window.
...
- Top agents: main (3,169,860 est tokens) · builder (449,384 est tokens) · trading-commander (423,022 est tokens)
- Top attribution buckets: interactive (2,594,725 est tokens) · cron (1,669,437 est tokens) · system/other (0 est tokens)
