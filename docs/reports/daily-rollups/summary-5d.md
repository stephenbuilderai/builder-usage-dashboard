...
## Trend narrative
- Estimated tokens moved down by 3,109 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,322,943 est tokens) · gpt-5-mini (1,137,150 est tokens) · gpt-5.2 (362,591 est tokens)
- Top agents: main (2,488,046 est tokens) · builder (337,038 est tokens) · trading-commander (333,574 est tokens)
- Top attribution buckets: interactive (1,953,787 est tokens) · cron (1,371,293 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +27.8% token shift vs previous day
