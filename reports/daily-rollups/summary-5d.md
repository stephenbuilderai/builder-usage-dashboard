...
## Trend narrative
- Estimated tokens moved down by 2,576 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,982,176 est tokens) · gpt-5.4 (1,902,876 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,359,286 est tokens) · builder (449,384 est tokens) · trading-commander (346,534 est tokens)
- Top attribution buckets: interactive (2,843,576 est tokens) · cron (1,533,524 est tokens) · system/other (0 est tokens)
