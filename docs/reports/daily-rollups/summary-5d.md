...
## Trend narrative
- Estimated tokens moved down by 268,960 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,893,607 est tokens) · gpt-5.4 (1,730,262 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,167,649 est tokens) · builder (449,384 est tokens) · trading-commander (423,022 est tokens)
- Top attribution buckets: interactive (2,588,263 est tokens) · cron (1,673,688 est tokens) · system/other (0 est tokens)
