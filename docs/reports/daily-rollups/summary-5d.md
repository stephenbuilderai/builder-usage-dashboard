...
## Trend narrative
- Estimated tokens moved up by 62,545 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,336,916 est tokens) · gpt-5-mini (1,150,363 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,204,360 est tokens) · builder (337,038 est tokens) · trading-commander (148,495 est tokens)
- Top attribution buckets: interactive (1,848,423 est tokens) · cron (1,007,892 est tokens) · system/other (0 est tokens)
