...
## Trend narrative
- Estimated tokens moved down by 18,629 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,420,783 est tokens) · gpt-5-mini (1,170,372 est tokens) · gpt-5.2 (343,373 est tokens)
- Top agents: main (2,503,270 est tokens) · builder (337,038 est tokens) · trading-commander (302,830 est tokens)
- Top attribution buckets: interactive (1,907,465 est tokens) · cron (1,402,095 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +26.1% token shift vs previous day
