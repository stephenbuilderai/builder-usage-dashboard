...
## Trend narrative
- Estimated tokens moved down by 181,048 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,808,626 est tokens) · gpt-5.4 (1,730,310 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,209,168 est tokens) · trading-commander (469,415 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,640,028 est tokens) · cron (1,709,835 est tokens) · system/other (0 est tokens)
