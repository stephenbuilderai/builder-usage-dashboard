...
## Trend narrative
- Estimated tokens moved up by 97,769 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,471,519 est tokens) · gpt-5-mini (1,050,984 est tokens) · gpt-5.3-codex (337,038 est tokens)
- Top agents: main (2,388,079 est tokens) · builder (337,038 est tokens) · growth-researcher (35,034 est tokens)
- Top attribution buckets: interactive (1,876,316 est tokens) · cron (1,015,223 est tokens) · system/other (0 est tokens)
