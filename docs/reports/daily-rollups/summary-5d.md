...
## Trend narrative
- Estimated tokens moved down by 138,866 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5-mini (1,809,902 est tokens) · gpt-5.4 (1,771,107 est tokens) · gpt-5.3-codex (449,384 est tokens)
- Top agents: main (3,212,832 est tokens) · trading-commander (507,933 est tokens) · builder (449,384 est tokens)
- Top attribution buckets: interactive (2,654,902 est tokens) · cron (1,737,143 est tokens) · system/other (0 est tokens)
