...
## Trend narrative
- Estimated tokens moved down by 36 across the available window.
- Estimated daily costs track token movement and remain rough heuristics.

## Biggest drivers
- Top models: gpt-5.4 (1,439,264 est tokens) · gpt-5-mini (1,187,802 est tokens) · gpt-5.2 (343,358 est tokens)
- Top agents: main (2,494,566 est tokens) · builder (337,038 est tokens) · trading-commander (330,127 est tokens)
- Top attribution buckets: interactive (1,923,448 est tokens) · cron (1,404,705 est tokens) · system/other (0 est tokens)

## Anomalies
- 2026-03-15: -21.9% token shift vs previous day
- 2026-03-16: +28.1% token shift vs previous day
